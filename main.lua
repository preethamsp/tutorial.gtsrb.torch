...
cmd:option('-maxEpochs',                60,         'Max # Epochs')
cmd:option('-batchSize',                32,         'batch size')
cmd:option('-nbClasses',                43,         '# of classes' )
cmd:option('-nbChannels',               3,          '# of channels' )
cmd:option('-backend',                  'cudnn',    'Options: cudnn | nn')
cmd:option('-model',                    'vgg_small','Options: vgg_small')
...
require 'datasets/gtsrb'
dgen = DataGen('datasets/GTSRB/')
